...
#Comment: same calculations in different ways
...
#Comment: again same calculations in different ways but we didin't use .copy() which might
#         lead to problems
...
#Comment: We used the outer product (as in the script) to update gard_B and went through the 
#         batches via a loop, exept for the update of grad_B the codes do the same (the solution
#         for the whole batch and we instance by instace)
...
# Comment: same calculations again but instancewise instead of batchwise
